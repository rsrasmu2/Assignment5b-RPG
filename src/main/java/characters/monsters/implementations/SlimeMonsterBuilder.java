...
public class SlimeMonsterBuilder implements MonsterBuilder {
    private Monster monster;

    public SlimeMonsterBuilder() {
        monster = new Monster();
    }
    ...
    public MonsterBuilder buildCombatStats() {
        monster.setCombatStats(new CombatStats(20, 15, 5, 15, 10));
        return this;
    }

    @Override
    public MonsterBuilder buildExperience() {
        monster.setExperience(110);
        return this;
    }
