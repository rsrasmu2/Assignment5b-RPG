...
public class StoneGiantMonsterBuilder implements MonsterBuilder {
    private Monster monster;

    public StoneGiantMonsterBuilder() {
        monster = new Monster();
    }

    @Override
    public MonsterBuilder buildName() {
        monster.setName("Stone Giant");
        return this;
    }
    ...
    public MonsterBuilder buildCombatStats() {
        monster.setCombatStats(new CombatStats(60, 60, 40, 50, 5));
        return this;
    }
