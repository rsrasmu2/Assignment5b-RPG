...
public class HobgoblinMonsterBuilder implements MonsterBuilder {
    private Monster monster;

    public HobgoblinMonsterBuilder() {
        monster = new Monster();
    }

    @Override
    public MonsterBuilder buildName() {
        monster.setName("Hobgoblin");
        return this;
    }
    ...
    public MonsterBuilder buildCombatStats() {
        monster.setCombatStats(new CombatStats(40, 35, 10, 30, 10));
        return this;
    }

    @Override
    public MonsterBuilder buildExperience() {
        monster.setExperience(180);
        return this;
    }
