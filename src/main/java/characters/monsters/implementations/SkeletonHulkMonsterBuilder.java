...
public class SkeletonHulkMonsterBuilder implements MonsterBuilder {
    private Monster monster;

    public SkeletonHulkMonsterBuilder() {
        monster = new Monster();
    }

    @Override
    public MonsterBuilder buildName() {
        monster.setName("Skeleton Hulk");
        return this;
    }

    @Override
    public MonsterBuilder buildHealth() {
        monster.setHealth(new CharacterResource("Health", 240));
        return this;
    }
    ...
    public MonsterBuilder buildCombatStats() {
        monster.setCombatStats(new CombatStats(110, 95, 70, 95, 10));
        return this;
    }

    @Override
    public MonsterBuilder buildExperience() {
        monster.setExperience(820);
        return this;
    }
